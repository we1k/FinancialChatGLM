...
for foldername in os.listdir(path):
    if re.match("20.*", foldername):
        #print(foldername)
        company = {'文档公司名':'','年份':'','企业名称':'', '外文名称':'-1', '证券简称':'', '证券代码':'', '法定代表人':'', '电子信箱':'', '办公地址':'', '注册地址': '', 
            '公司网址':'', '营业收入':'', '净利润':'', '现金流量净额':'', '每股收益':'', '净资产':'','职工总数':'-1', '技术人员数':'-1',
            '研发人员数':'-1', '硕士人数':'-1', '博士及以上':'-1', '研发人员比例': '-1'}
        company['文档公司名'] = foldername.split('__')[-3]
        company['年份'] = foldername.split('__')[-2]
                        ...
                        for index, line in enumerate(lines):
                            ...
                            '''
                                company = {'企业名称':c_name, '外文名称':e_name, '证券简称':share, '证券代码':s_code, 
                                        '法定代表人是什么':corporation, '电子信箱':mail, '办公地址':w_addr, 
